...
class FireportDeviceData : public IFireportDeviceData
{
  public:
    struct Cols
    {
     ...
     */
    explicit FireportDeviceData(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit FireportDeviceData(const Json::Value &pJson) noexcept(false);
     ...
     */
    FireportDeviceData(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    FireportDeviceData() = default;
  ...
  private:
    friend drogon::orm::Mapper<FireportDeviceData>;
    friend drogon::orm::BaseBuilder<FireportDeviceData, true, true>;
    friend drogon::orm::BaseBuilder<FireportDeviceData, true, false>;
    friend drogon::orm::BaseBuilder<FireportDeviceData, false, true>;
    friend drogon::orm::BaseBuilder<FireportDeviceData, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<FireportDeviceData>;
#endif
