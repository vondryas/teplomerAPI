...
class Users : public IUsers
{
  ...
  public:
    struct Cols
    {
        ...
        static const std::string _passhash;
    ...
    /**  For column passhash  */
    ///Get the value of the column passhash, returns the default value if the column is null
    const std::string &getValueOfPasshash() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPasshash() const noexcept;
    ///Set the value of the column passhash
    void setPasshash(const std::string &pPasshash) noexcept;
    void setPasshash(std::string &&pPasshash) noexcept;

    /**  For column role  */
    ///Get the value of the column role, returns the default value if the column is null
    const int32_t &getValueOfRole() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getRole() const noexcept;
    ///Set the value of the column role
    void setRole(const int32_t &pRole) noexcept;
    ...
    std::vector<Devices> getDevices(const drogon::orm::DbClientPtr &clientPtr) const;
    void getDevices(const drogon::orm::DbClientPtr &clientPtr,
  ...
  private:
    ...
    std::shared_ptr<std::string> passhash_;
    std::shared_ptr<int32_t> role_;
    struct MetaData
    {
