...
void list_model::DevicesList::mapToOrmModel(model_interface::IModel& model) const
{
...
void list_model::DevicesList::mapToListModel(model_interface::IModel& model) const
{
	LOG_INFO << "Mapping list model to another list model";
	auto& sensorDataList = dynamic_cast<DevicesList&>(model);
...
void list_model::DevicesList::mapToRequestModel(model_interface::IModel& model) const
{
...
Json::Value list_model::DevicesList::toJson() const
{
	Json::Value json;
