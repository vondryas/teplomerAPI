#include "WeatherStationDataList.h"

void list_model::WeatherStationDataList::mapToOrmModel(model_interface::IModel& model) const
{
...
void list_model::WeatherStationDataList::mapToListModel(model_interface::IModel& model) const
{
	LOG_INFO << "Mapping list model to another list model";
	auto& sensorDataList = dynamic_cast<WeatherStationDataList&>(model);
...
void list_model::WeatherStationDataList::mapToRequestModel(model_interface::IModel& model) const
{
...
Json::Value list_model::WeatherStationDataList::toJson() const
{
	Json::Value json;
